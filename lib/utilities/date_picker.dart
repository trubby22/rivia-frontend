...
class _DatePickerDialogState extends State<DatePickerDialog>
  ...
  void _handleReset() {
    setState(() => _selectedDate.value = widget.currentDate);
  }
    ...
    final Widget actions = Container(
      ...
      child: OverflowBar(
        ...
        children: <Widget>[
          ...
          TextButton(
            onPressed: _selectedDate.value.day != widget.currentDate.day ||
                    _selectedDate.value.month != widget.currentDate.month ||
                    _selectedDate.value.year != widget.currentDate.year
                ? _handleReset
                : null,
            child: Text('TODAY'),
          ),
...
class _DateRangePickerDialogState extends State<DateRangePickerDialog>
  ...
  Widget build(BuildContext context) {
    ...
    final double textScaleFactor = min(mediaQuery.textScaleFactor, 1.3);
    final MaterialLocalizations localizations =
        MaterialLocalizations.of(context);
