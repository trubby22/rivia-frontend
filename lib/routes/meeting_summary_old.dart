...
class MeetingSummaryOld extends StatefulWidget {
  final Meeting meeting;

  const MeetingSummaryOld({
    Key? key,
    required this.meeting,
  }) : super(key: key);

  @override
  State<MeetingSummaryOld> createState() => _MeetingSummaryOldState();
}

class _MeetingSummaryOldState extends State<MeetingSummaryOld> {
